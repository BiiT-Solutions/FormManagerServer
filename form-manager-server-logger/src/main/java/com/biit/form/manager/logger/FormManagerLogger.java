package com.biit.form.manager.logger;

/*-
 * #%L
 * Form Manager Server (Logger)
 * %%
 ...
 */
public class FormManagerLogger extends BiitLogger {

    private static Logger logger = LoggerFactory.getLogger(FormManagerLogger.class);
